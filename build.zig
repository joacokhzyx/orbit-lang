...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("orbit_binary", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "orbit_binary" is the name you will use in your source code to
                // import this module (e.g. `@import("orbit_binary")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "orbit_binary", .module = mod },
            },
        }),
    });
    ...
    // Orbit compiler regression test suite (src/tests.zig)
    const orbit_tests = b.addTest(.{
        .root_module = b.createModule(.{
    ...
    run_orbit_tests.step.dependOn(b.getInstallStep());
