 ...
 *
 * Serves a plain dashboard at /_pulse and a JSON API at /_pulse/data.
...
"            <div class='card-sub'>Average CPU cycles per request</div>"
"        </div>"
"        <div class='card'>"
...
"            <div class='card-sub' id='sec-ips'>0 blocked requests</div>"
"        </div>"
"        <div class='card'>"
...
"                document.getElementById('sec-ips').innerText = d.security.tracked_ips + ' addresses tracked';"
